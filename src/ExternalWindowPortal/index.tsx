...
interface ExternalWindowPortalProps {
  listenForUnload?: () => void; // this prop allows for listening when the external window is closed so that any cleanup/state changes can occur
}
interface ExternalWindowPortalState {
  win: Window;
  el: HTMLDivElement;
}
class ExternalWindowPortal extends React.Component<
  ExternalWindowPortalProps,
  ExternalWindowPortalState
> {
  state: ExternalWindowPortalState = {
    // @ts-ignore
    el: null,
    // @ts-ignore
    win: null
